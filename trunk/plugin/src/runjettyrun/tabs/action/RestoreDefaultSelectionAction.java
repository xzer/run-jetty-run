 ...
 */
public class RestoreDefaultSelectionAction extends RuntimeClasspathAction {
	 ...
	 */
	public RestoreDefaultSelectionAction(IClasspathViewer viewer, AbstractClasspathTab tab
			,String customAttributeName
	) {
		super("R&estore Default Selections", viewer);
